...
2. It then loads this file, to retrieve the meta-data of each module such as its name and dependencies. 
3. It then adds for each module a ``MODULE_<module>`` option to the build configuration. 
