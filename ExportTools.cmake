...
function (basis_export_build_properties CODE)
  ...
  foreach (T IN LISTS ARGN)
    ...
    set (C "${C}set_property (TARGET ${UID} APPEND PROPERTY IMPORTED_CONFIGURATIONS ${CONFIG_UPPER})\n")
    ...
    if (BASIS_TYPE MATCHES "SCRIPT|LIBRARY|MEX")
      ...
      if (LANGUAGE)
        set (C "${C}  IMPORTED_LINK_INTERFACE_LANGUAGES_${CONFIG_UPPER} \"${LANGUAGE}\"\n")
      endif ()
      ...
      endforeach ()
      set (C "${C}  IMPORTED_LINK_INTERFACE_LIBRARIES_${CONFIG_UPPER} \"${LINK_UIDS}\"\n")
    endif ()
