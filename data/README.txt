Whenever a template file is modified, added, or removed, the previous project
template has to be copied to a new directory with an updated template version!
