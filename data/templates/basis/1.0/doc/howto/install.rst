...
.. meta::
    :description: General build and installation instructions for projects developed using BASIS.

====================
Install any Software
====================

The following contains general build and installation instructions which apply to
any project which is developed using CMake BASIS.


.. _BriefInstallationSteps:

Build Steps Overview
====================

See :ref:`GeneralBuildDependencies` below for information on dependencies.

Build Steps
-----------

The common steps to build, test, and install software from source code
based on CMake are as follows:
...
.. _GeneralBuildDependencies:

Prerequisites
=============

The following software packages are prerequisites for any software that is based on BASIS.
Note that the stated package versions are usually the minimum versions for which it is known
that the software is working with. Newer versions will usually be fine as well if not otherwise
stated by the particular software documentation, but less certainly older versions.

See the installation instructions of the specific software package for details on what is required
and which optional software is being used if available. For instructions on how to build or
install any of the following software packages, please refer to the documentation of the
respective package.
...
will also trigger the build of the software. To build both the manual and API
