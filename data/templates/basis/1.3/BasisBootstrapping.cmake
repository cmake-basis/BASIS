...
function (basis_bootstrap)
  ...
  # update BASIS_DIR cache entry and mark it as advanced variable
  get_property (BASIS_DIR_CACHED CACHE BASIS_DIR PROPERTY TYPE SET)
  if (BASIS_DIR_CACHED)
    set_property (CACHE BASIS_DIR PROPERTY VALUE ${BASIS_DIR})
    mark_as_advanced (FORCE BASIS_DIR)
  else ()
