...
macro (basis_project_impl)
  ...
  if (PYTHON_EXECUTABLE AND PYTHON_VERSION_MAJOR EQUAL 0 OR (PYTHON_VERSION_MAJOR EQUAL 1 AND PYTHON_VERSION_MINOR EQUAL 4))
    message (WARNING "Failed to determine Python version! Make sure that the correct version of the Python libraries are being found.")
    unset (_HINT)
  endif ()
  if (JYTHON_EXECUTABLE AND JYTHON_VERSION_MAJOR EQUAL 0)
    message (WARNING "Failed to determine Jython version! Make sure that the correct version of the Python libraries are being found.")
  endif ()
