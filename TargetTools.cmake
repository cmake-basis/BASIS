...
function (basis_add_script TARGET_NAME)
  ...
  elseif (ARGN_MODULE)
    if (SCRIPT_LANGUAGE MATCHES "PYTHON")
      basis_sanitize_for_regex (REGEX "${INSTALL_PYTHON_LIBRARY_DIR}")
      string (REGEX REPLACE "^${REGEX}/?" "" DIR "${ARGN_DESTINATION}")
      set (OUTPUT_DIRECTORY "${BINARY_PYTHON_LIBRARY_DIR}/${DIR}")
    elseif (SCRIPT_LANGUAGE MATCHES "PERL")
      basis_sanitize_for_regex (REGEX "${INSTALL_PERL_LIBRARY_DIR}")
      string (REGEX REPLACE "^${REGEX}/?" "" DIR "${ARGN_DESTINATION}")
      set (OUTPUT_DIRECTORY "${BINARY_PERL_LIBRARY_DIR}/${DIR}")
    else ()
