...
macro (basis_find_package PACKAGE)
  ...
  elseif (BUNDLE_PROJECTS MATCHES "(^|;)${PKG}(;|$)")
    ...
    if  (EXISTS "${CMAKE_INSTALL_PREFIX}/${BUNDLE_CONFIG_DIR}/${PKG_L}/${PKG}Config.cmake")
      if (BASIS_DEBUG)
        message ("**     Identified it as other package of this bundle.")
      endif ()
      basis_set_or_update_value (${PKG}_DIR "${CMAKE_INSTALL_PREFIX}/${BUNDLE_CONFIG_DIR}/${PKG_L}")
      include ("${${PKG}_DIR}/${PKG}Config.cmake")
      set (${PKG}_FOUND TRUE)
    elseif (EXISTS "${CMAKE_INSTALL_PREFIX}/${BUNDLE_CONFIG_DIR}/${PKG_L}/${PKG_L}-config.cmake")
      if (BASIS_DEBUG)
        message ("**     Identified it as other package of this bundle.")
      endif ()
      basis_set_or_update_value (${PKG}_DIR "${CMAKE_INSTALL_PREFIX}/${BUNDLE_CONFIG_DIR}/${PKG_L}")
      include ("${${PKG}_DIR}/${PKG_L}-config.cmake")
      set (${PKG}_FOUND TRUE)
    endif ()
    unset (PKG_L)
  endif ()
