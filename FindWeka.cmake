...
if (Weka_DIR)
  ...
  if (Weka_CLASSPATH)
    ...
    if (Weka_DIR MATCHES "/weka$" AND EXISTS "${Weka_DIR}/WekaManual.pdf")
      string (REGEX REPLACE "/weka$" "" Weka_DIR "${Weka_DIR}")
    elseif (Weka_DIR MATCHES "/Contents/Resources/Java$")
      string (REGEX REPLACE "/Contents/Resources/Java$" "" Weka_DIR "${Weka_DIR}")
    elseif (Weka_DIR MATCHES "/Resources/Java$")
      string (REGEX REPLACE "/Resources/Java$" "" Weka_DIR "${Weka_DIR}")
    endif ()
