...
set (TESTING_PYTHON_LIBRARY_DIR "${BASIS_PROJECT_BINARY_DIR}/Testing/lib/python")
set (TESTING_JYTHON_LIBRARY_DIR "${BASIS_PROJECT_BINARY_DIR}/Testing/lib/jython")
set (TESTING_PERL_LIBRARY_DIR   "${BASIS_PROJECT_BINARY_DIR}/Testing/lib/perl5")
set (TESTING_MATLAB_LIBRARY_DIR "${BASIS_PROJECT_BINARY_DIR}/Testing/lib/matlab")
set (TESTING_BASH_LIBRARY_DIR   "${BASIS_PROJECT_BINARY_DIR}/Testing/lib/bash")
...
set (BINARY_BASH_LIBRARY_DIR   "${BASIS_PROJECT_BINARY_DIR}/lib/bash")
...
if (BASIS_INSTALL_SCHEME MATCHES "win")
  ...
  # Bash - usually not for Windows though
  if (BASH_VERSION_MAJOR AND DEFINED BASH_VERSION_STRING)
    set (INSTALL_BASH_LIBRARY_DIR "Library/Bash${BASH_VERSION_MAJOR}.${BASH_VERSION_MINOR}")
  else ()
    set (INSTALL_BASH_LIBRARY_DIR "Library/Bash")
  endif ()
...
elseif (BASIS_INSTALL_SCHEME MATCHES "usr")
  ...
  # Python
  if (PYTHON_VERSION_MAJOR AND DEFINED PYTHON_VERSION_MINOR)
    set (INSTALL_PYTHON_LIBRARY_DIR "lib${_MODULE}/python${PYTHON_VERSION_MAJOR}.${PYTHON_VERSION_MINOR}/site-packages")
  else ()
    set (INSTALL_PYTHON_LIBRARY_DIR "lib${_MODULE}/python/site-packages")
  endif ()
  # Jython
  if (JYTHON_VERSION_MAJOR AND DEFINED JYTHON_VERSION_MINOR)
    set (INSTALL_JYTHON_LIBRARY_DIR "lib${_MODULE}/jython${JYTHON_VERSION_MAJOR}.${JYTHON_VERSION_MINOR}/site-packages")
  else ()
    set (INSTALL_JYTHON_LIBRARY_DIR "lib${_MODULE}/jython/site-packages")
  endif ()
  # Perl
  if (PERL_VERSION_MAJOR AND DEFINED PERL_VERSION_STRING)
    set (INSTALL_PERL_LIBRARY_DIR "lib${_MODULE}/perl${PERL_VERSION_MAJOR}/site_perl/${PERL_VERSION_STRING}")
  else ()
    set (INSTALL_PERL_LIBRARY_DIR "lib${_MODULE}/perl/site_perl")
  endif ()
  # MATLAB
  if (MATLAB_RELEASE)
    set (INSTALL_MATLAB_LIBRARY_DIR "lib${_MODULE}/matlab/${MATLAB_RELEASE}")
  elseif (MATLAB_VERSION_MAJOR AND DEFINED MATLAB_VERSION_MINOR)
    set (INSTALL_MATLAB_LIBRARY_DIR "lib${_MODULE}/matlab${MATLAB_VERSION_MAJOR}.${MATLAB_VERSION_MINOR}")
  else ()
    set (INSTALL_MATLAB_LIBRARY_DIR "lib${_MODULE}/matlab")
  endif ()
  # Bash
  if (BASH_VERSION_MAJOR AND DEFINED BASH_VERSION_STRING)
    set (INSTALL_BASH_LIBRARY_DIR "lib${_MODULE}/bash${BASH_VERSION_MAJOR}.${BASH_VERSION_MINOR}")
  else ()
    set (INSTALL_BASH_LIBRARY_DIR "lib${_MODULE}/bash")
  endif ()
  ...
  # Bash
  if (BASH_VERSION_MAJOR AND DEFINED BASH_VERSION_STRING)
    set (INSTALL_BASH_LIBRARY_DIR "lib/bash${BASH_VERSION_MAJOR}.${BASH_VERSION_MINOR}")
  else ()
...
if (BASIS_INSTALL_SCHEME MATCHES "win")
  ...
  if (NOT INSTALL_PYTHON_SITE_DIR)
    if (PYTHON_VERSION_MAJOR AND DEFINED PYTHON_VERSION_MINOR)
      set (INSTALL_PYTHON_SITE_DIR "Library/Python${PYTHON_VERSION_MAJOR}.${PYTHON_VERSION_MINOR}")
    else ()
      set (INSTALL_PYTHON_SITE_DIR "Library/Python")
    endif ()
  endif ()
  # Jython
  if (NOT INSTALL_JYTHON_SITE_DIR)
    if (JYTHON_VERSION_MAJOR AND DEFINED JYTHON_VERSION_MINOR)
      set (INSTALL_JYTHON_SITE_DIR "Library/Jython${JYTHON_VERSION_MAJOR}.${JYTHON_VERSION_MINOR}")
    else ()
      set (INSTALL_JYTHON_SITE_DIR "Library/Jython")
    endif ()
  endif ()
  # Perl
  if (NOT INSTALL_PERL_SITE_DIR)
    if (PERL_VERSION_MAJOR AND DEFINED PERL_VERSION_STRING)
      set (INSTALL_PERL_SITE_DIR "Library/Perl${PERL_VERSION_MAJOR}/site_perl/${PERL_VERSION_STRING}")
    else ()
      set (INSTALL_PERL_SITE_DIR "Library/Perl/site_perl")
    endif ()
  endif ()
  # MATLAB
  ...
  if (NOT INSTALL_BASH_SITE_DIR)
    if (BASH_VERSION_MAJOR AND DEFINED BASH_VERSION_STRING)
      set (INSTALL_BASH_SITE_DIR "Library/Bash${BASH_VERSION_MAJOR}.${BASH_VERSION_MINOR}")
    else ()
      set (INSTALL_BASH_SITE_DIR "Library/Bash")
    endif ()
  endif ()
