...
# JsUnit port for JavaScript.
#
# @sa http://jsunit.berlios.de/internal.html
#
...
=head1 SYNOPSIS
 ...
 doxygen-javascript-filter.pl < file.js > file.cpp
 doxygen-javascript-filter.pl [Options] file.js
