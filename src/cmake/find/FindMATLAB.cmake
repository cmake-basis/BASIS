...
# set MATLAB_DIR
if (NOT MATLAB_DIR)
  set (_MATLAB_EXE "${MATLAB_EXECUTABLE}")
  if (NOT _MATLAB_EXE)
    foreach (_MATLAB_EXE_U IN LISTS _MATLAB_EXECUTABLE_NAMES _MATLAB_OPTIONAL_EXECUTABLE_NAMES)
      string (TOUPPER "${_MATLAB_EXE_U}" _MATLAB_EXE_U)
      if (MATLAB_${_MATLAB_EXE_U}_EXECUTABLE)
        set (_MATLAB_EXE "${MATLAB_${_MATLAB_EXE_U}_EXECUTABLE}")
        break ()
      endif ()
    endforeach ()
  endif ()
  if (_MATLAB_EXE)
    if (APPLE)
      string (REGEX REPLACE "^(.+\\.app)/.*$" "\\1" _MATLAB_PREFIX "${_MATLAB_EXE}")
    else ()
      string (REGEX REPLACE "/bin(/[a-z0-9]+)?/(matlab|MATLAB)(\\.exe|\\.EXE)?$" "" _MATLAB_PREFIX "${_MATLAB_EXE}")
    endif ()
