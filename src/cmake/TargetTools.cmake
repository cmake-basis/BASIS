...
function (basis_add_script_finalize TARGET_UID)
  ...
  # create build script
  #
  # Note: The script is first configured to an intermediate file with extension.
  #       This file can then be used to generate a Doxgyen documentation.
  #       Finally, the file is copied to either the output directory where the
  ...
  # configure the script first using the script configuration and then copy it
  # to the output directory for runtime files. Otherwise, just copy the script file
  # directoy to the output directory.
