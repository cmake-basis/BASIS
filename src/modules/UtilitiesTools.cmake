...
function (basis_configure_auxiliary_sources SOURCES HEADERS PUBLIC_HEADERS)
  ...
  set (
    SOURCES_NAMES
      ...
      "stdaux.h"
      "stdaux.cxx"
      # ExecutableTargetInfo.h is configured later by basis_configure_ExecutableTargetInfo
...
function (basis_configure_ExecutableTargetInfo)
  ...
  if (CXX)
    ...
    # configure header file instead of .cxx file here as
    # 1) .cxx file must be configured before build target can be added
    # 2) Configuring a .cxx file twice would trigger a rebuild whenever
    #    the CMake build configuration changed.
    configure_file (
      "${BASIS_CXX_TEMPLATES_DIR}/ExecutableTargetInfo.h.in"
      "${BINARY_CODE_DIR}/basis/ExecutableTargetInfo.h"
      @ONLY
    )
  endif ()
