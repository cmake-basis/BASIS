...
function (basis_configure_auxiliary_sources SOURCES HEADERS PUBLIC_HEADERS)
  ...
  set (SOURCE_OUT "${BINARY_CODE_DIR}/basis/ExecutableTargetInfo.cxx")
...
function (basis_configure_auxiliary_modules)
  basis_get_project_property (BASIS_PROJECT_USES_PYTHON_UTILITIES)
  basis_get_project_property (BASIS_PROJECT_USES_PERL_UTILITIES)
  basis_get_project_property (BASIS_PROJECT_USES_BASH_UTILITIES)

  if (NOT BASIS_PROJECT_USES_PYTHON_UTILITIES AND
      NOT BASIS_PROJECT_USES_PERL_UTILITIES   AND
      NOT BASIS_PROJECT_USES_BASH_UTILITIES)
    return ()
  endif ()
...
function (basis_configure_ExecutableTargetInfo)
  ...
  if (NOT BASIS_PROJECT_USES_CXX_UTILITIES    AND
      NOT BASIS_PROJECT_USES_PYTHON_UTILITIES AND
      NOT BASIS_PROJECT_USES_PERL_UTILITIES   AND
      NOT BASIS_PROJECT_USES_BASH_UTILITIES)
    return ()
  endif ()
  ...
  if (BASIS_PROJECT_USES_CXX_UTILITIES)
  ...
  if (BASIS_PROJECT_USES_CXX_UTILITIES)
    ...
    configure_file (
      ...
      "${BINARY_CODE_DIR}/basis/ExecutableTargetInfo.cxx"
      @ONLY
    )
  endif ()
