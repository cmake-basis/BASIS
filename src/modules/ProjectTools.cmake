...
macro (basis_project_finalize)
  ...
  foreach (MODULE ${PROJECT_MODULES_ENABLED})
    ...
    basis_set_project_property (EXPORT_TARGETS APPEND ${${MODULE}_EXPORT_TARGETS})
    basis_set_project_property (CUSTOM_EXPORT_TARGETS APPEND ${${MODULE}_CUSTOM_EXPORT_TARGETS})
  endforeach ()
