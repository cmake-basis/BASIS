...
#   </tr>
#   <tr>
#     @tp @b HTML_STYLESHEET css_file @endtp
...
#         @c "PROJECT_SOURCE_DIR/doc/doxygen.css(.in)?" file is used if present.
#         It is recommended to use @c HTML_EXTRA_STYLESHEET instead, as it is more robust
#         and @c HTML_STYLESHEET will in the future become obsolete.</td>
#   </tr>
#   <tr>
...
function (basis_add_doxygen_doc TARGET_NAME)
  ...
  set (VALUEARGS
    ...
    PROJECT_PROVIDER_DIVISION
    PROJECT_PROVIDER_DIVISION_WEBSITE
    COMPONENT
    DESTINATION
    HTML_DESTINATION
    MAN_DESTINATION
  ...
  if (DOXYGEN_PROJECT_PROVIDER_LOGO)
    set (DOXYGEN_PROJECT_PROVIDER_LOGO_VISIBILITY "visible")
  else ()
    set (DOXYGEN_PROJECT_PROVIDER_LOGO_VISIBILITY "hidden")
  endif ()
  if (DOXYGEN_PROJECT_PROVIDER_DIVISION_LOGO)
    set (DOXYGEN_PROJECT_PROVIDER_DIVISION_LOGO_VISIBILITY "visible")
  else ()
    set (DOXYGEN_PROJECT_PROVIDER_DIVISION_LOGO_VISIBILITY "hidden")
  endif ()
  ...
  if (NOT DOXYGEN_HTML_STYLESHEET)
    if (EXISTS "${PROJECT_SOURCE_DIR}/doc/doxygen.css.in")
      set (DOXYGEN_HTML_STYLESHEET "${PROJECT_SOURCE_DIR}/doc/doxygen.css.in")
    elseif (EXISTS "${PROJECT_SOURCE_DIR}/doc/doxygen.css")
      set (DOXYGEN_HTML_STYLESHEET "${PROJECT_SOURCE_DIR}/doc/doxygen.css")
    endif ()
  endif ()
  if (NOT DOXYGEN_HTML_EXTRA_STYLESHEET)
    if (EXISTS "${PROJECT_SOURCE_DIR}/doc/doxygen_extra.css.in")
      set (DOXYGEN_HTML_STYLESHEET "${PROJECT_SOURCE_DIR}/doc/doxygen_extra.css.in")
    elseif (EXISTS "${PROJECT_SOURCE_DIR}/doc/doxygen_extra.css")
      set (DOXYGEN_HTML_STYLESHEET "${PROJECT_SOURCE_DIR}/doc/doxygen_extra.css")
    endif ()
  endif ()
  if (NOT DOXYGEN_HTML_HEADER)
    if (EXISTS "${PROJECT_SOURCE_DIR}/doc/doxygen_header.html.in")
      set (DOXYGEN_HTML_HEADER "${PROJECT_SOURCE_DIR}/doc/doxygen_header.html.in")
    elseif (EXISTS "${PROJECT_SOURCE_DIR}/doc/doxygen_header.html")
      set (DOXYGEN_HTML_HEADER "${PROJECT_SOURCE_DIR}/doc/doxygen_header.html")
    endif ()
  endif ()
  if (NOT DOXYGEN_HTML_FOOTER)
    if (EXISTS "${PROJECT_SOURCE_DIR}/doc/doxygen_footer.html.in")
      set (DOXYGEN_HTML_FOOTER "${PROJECT_SOURCE_DIR}/doc/doxygen_footer.html.in")
    elseif (EXISTS "${PROJECT_SOURCE_DIR}/doc/doxygen_footer.html")
      set (DOXYGEN_HTML_FOOTER "${PROJECT_SOURCE_DIR}/doc/doxygen_footer.html")
    endif ()
  endif ()
  # configure/copy custom HTML ressource files
  if (DOXYGEN_GENERATE_HTML)
    set (OUTPUT_HTML_STYLESHEET       "${CMAKE_CURRENT_BINARY_DIR}/doxygen.css")
    set (OUTPUT_HTML_EXTRA_STYLESHEET "${CMAKE_CURRENT_BINARY_DIR}/doxygen_extra.css")
    set (OUTPUT_HTML_HEADER           "${CMAKE_CURRENT_BINARY_DIR}/doxygen_header.html")
    set (OUTPUT_HTML_FOOTER           "${CMAKE_CURRENT_BINARY_DIR}/doxygen_footer.html")
    foreach (res IN ITEMS STYLESHEET EXTRA_STYLESHEET HEADER FOOTER)
    ...
    endforeach ()
    set  (DOXYGEN_HTML_STYLESHEET       "${OUTPUT_HTML_STYLESHEET}")
  ...
  if (DOXYGEN_PROJECT_PROVIDER_LOGO)
    list (APPEND DOXYGEN_HTML_EXTRA_FILES "${DOXYGEN_PROJECT_PROVIDER_LOGO}")
  endif()
  if (DOXYGEN_PROJECT_PROVIDER_DIVISION_LOGO)
    list (APPEND DOXYGEN_HTML_EXTRA_FILES "${DOXYGEN_PROJECT_PROVIDER_DIVISION_LOGO}")
  endif()
