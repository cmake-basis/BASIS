...
function (basis_add_doc TARGET_NAME)
  ...
  elseif (ARGN_GENERATOR MATCHES "DOXYGEN")
    ...
    if (DOXYGEN_INPUT_FILTER)
      if (WIN32)
        # Doxygen on Windows at least up to version 1.8.0 has the problem of not calling
        # filters which have a space character in their file path correctly.
        # The doxyfilter.bat Batch program is used as a wrapper for the actual filter
        # which is part of the BASIS build. As this file is in the working directory of
        # Doxygen, it can be referenced relative to this working directory, i.e., without
        # file paths. The Batch program itself then calls the actual Doxygen filter with
        # proper quotes to ensure that spaces in the file path are handled correctly.
        # The file extension .bat shall distinguish this wrapper script from the actual
        # doxyfilter.cmd which is generated by BASIS for the doxyfilter target on Windows.
