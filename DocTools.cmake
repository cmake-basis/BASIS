...
function (basis_add_sphinx_doc TARGET_NAME)
  ...
  set (_SPHINX_TEMPLATES_PATH)
  foreach (D IN LISTS SPHINX_TEMPLATES_PATH)
    if (NOT IS_ABSOLUTE "${D}")
      set (D "${SPHINX_SOURCE_DIRECTORY}/${D}")
    endif ()
    list (APPEND _SPHINX_TEMPLATES_PATH "${D}")
  endforeach ()
  set (SPHINX_TEMPLATES_PATH "${_SPHINX_TEMPLATES_PATH}")
  ...
  set (_SPHINX_HTML_STATIC_PATH)
  foreach (D IN LISTS SPHINX_HTML_STATIC_PATH)
    if (NOT IS_ABSOLUTE "${D}")
      set (D "${SPHINX_SOURCE_DIRECTORY}/${D}")
    endif ()
    list (APPEND _SPHINX_HTML_STATIC_PATH "${D}")
  endforeach ()
  set (SPHINX_HTML_STATIC_PATH "${_SPHINX_HTML_STATIC_PATH}")
  ...
  # turn html_logo into absolute file path
  if (SPHINX_HTML_LOGO AND NOT IS_ABSOLUTE "${SPHINX_HTML_LOGO}")
    if (EXISTS "${SPHINX_SOURCE_DIRECTORY}/${SPHINX_HTML_LOGO}")
      set (SPHINX_HTML_LOGO "${SPHINX_SOURCE_DIRECTORY}/${SPHINX_HTML_LOGO}")
    else ()
      foreach (D IN LISTS SPHINX_HTML_STATIC_PATH)
        if (EXISTS "${D}/${SPHINX_HTML_LOGO}")
          set (SPHINX_HTML_LOGO "${D}/${SPHINX_HTML_LOGO}")
          break ()
        endif ()
      endforeach ()
    endif ()
