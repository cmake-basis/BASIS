 ...
 *
 * This implementation of the test driver utilizes the ITK before version 4.
 *
...
{
    BASIS_THROW(runtime_error, "Not implemented yet! Use ITK 4 implementation instead.");
}
